<template>
    ...
    >
      <template v-slot:text>
        GOA can help you locate quickly.Click to switch to a different GOA.
      </template>
    ...
    <div style="position: relative;height: 350px;">
        ...
        <v-main v-if="showResult">
            <v-card class="mx-auto" max-width="600">
                <v-list lines="two">
                    <v-list-item  v-for="item in placeInfo" :key="item.displayName.text" :subtitle="item.distance + 'KM'"
